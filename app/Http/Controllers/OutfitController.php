...
class OutfitController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $outfit->save();
        return redirect()->route('outfit.index')->with('success_message', 'Outfit had been created');
    }
    ...
    public function update(Request $request, Outfit $outfit)
    {
        ...
        $outfit->master_id = $request->master_id;
        $outfit->save();
        return redirect()->route('outfit.index')->with('success_message', 'Outfit had been updated');
    }
    ...
    {
        $outfit->delete();
        return redirect()->route('outfit.index')->with('info_message', 'Outfit has been destroyed');
    }
}
